...
import View.Budi07154_GUI;

public class main {
    private static AdminController pegawaiModel = new AdminController(); 
    private static PenyewaController pembeliModel = new PenyewaController();
    ...
    void GUI(){
        Budi07154_GUI gui = new Budi07154_GUI();
    }
    ...
    void viewMenu(){
        ...
        do{
           System.out.print("Selamat Datang Di Sewa Apartemen Murah !!" +
                            "\n 1. Login" +
                            "\n 2. Daftar Pelanggan" +
                            "\n 3. Hapus Pelanggan"+
                            "\n 4. Lihat Pelanggan"+
        ...
        for (int i = 0; i < ApartemenEntity.apartemen.length; i++) {
            System.out.println((i) + " " + ApartemenEntity.apartemen[i]);
        }
        ...
        int i=0;
        for (DaftarPenyewaEntity pembeli : pembeliModel.cekDaftarPembeliModel()) {
                ...
                System.out.println("Apartemen = "+ApartemenEntity.apartemen[pembeliModel.showDaftarPembeli(i).getIndexTas()]);
        ...
        if (cekpembeli == -1){
            System.out.println("Anda belum memilih apartemen");
                registerPembeli();
        ...
        System.out.println("Apartemen = "+ApartemenEntity.apartemen[pembeliModel.showDaftarPembeli(cekpembeli).getIndexTas()]);
        System.out.println("isVerified = ");
